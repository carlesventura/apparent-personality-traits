function activation_unit_highest_image(name_layer,idx_unit)
val_dir = '../../test_jpg';
...
net = load('../train/data/exp_regression_avgmax_l28_pdist/net-epoch-10.mat');
net = net.net;
...
output_dir = ['detectors_images/' name_layer '/unit_' sprintf('%03d', idx_unit)]
mkdir(output_dir); 

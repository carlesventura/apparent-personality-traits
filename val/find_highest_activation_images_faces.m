predicted_values_test = csvread('predictions_reg_avg_max_l28_localization_normalization_faces.csv',1,1);
...
save('highest_activation_images_faces.mat','extraversion_highest', 'agreeableness_highest', 'conscientiousness_highest', 'neuroticism_highest', 'openness_highest');

%save('lowest_activation_images_faces.mat','extraversion_lowest', 'agreeableness_lowest', 'conscientiousness_lowest', 'neuroticism_lowest', 'openness_lowest');

...
load('highest_activation_images.mat')
gpuDevice(3);
net = load('../train/data/exp_regression_avgmax_l28_localization_with_normalization/net-epoch-10.mat');
net = net.net;
net = dagnn.DagNN.loadobj(net);
net.mode = 'test' ;
net.removeLayer('loss');
net.move('gpu') ;
imdb = load('../utils/imdb_trainval_carles.mat');
inputVar = 'x0';

output_dir = 'extraversion_highest_relu';
mkdir(output_dir);
...
output_dir = 'agreeableness_highest_relu';
mkdir(output_dir);
...
output_dir = 'conscientiousness_highest_relu';
mkdir(output_dir);
...
output_dir = 'neuroticism_highest_relu';
mkdir(output_dir);
...
output_dir = 'openness_highest_relu';
mkdir(output_dir);
